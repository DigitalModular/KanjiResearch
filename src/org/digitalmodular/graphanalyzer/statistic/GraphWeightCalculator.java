 ...
 */
// Created 2018-02-04
public final class GraphWeightCalculator implements GlobalGraphStatisticCalculator<Graph> {
	public static final GraphWeightCalculator INSTANCE = new GraphWeightCalculator();

	private GraphWeightCalculator() {
		if (INSTANCE != null)
